...
class OasisTestCase(BlueprintTestCase):
    ...
    #     action = ctx_deposit.actions.get(self.token_b) or NCDepositAction(
    #         amount=Amount(0), token_uid=self.token_b
    #     )
    ...
    #         ctx = Context(
    #             [
    #                 NCDepositAction(amount=swap_amount, token_uid=self.token_b),
    #                 NCWithdrawalAction(amount=amount_out, token_uid=self.token_a),
    #             ],
    #             self.tx,
    ...
    #     ctx_deposit, timelock, htr_amount = self.test_user_deposit(timelock=6)
    #     user_address = ctx_deposit.address
    #     action = ctx_deposit.actions.get(self.token_b) or NCWithdrawalAction(
